...
def main():
    ...
    elif args.model_name_or_path == "microsoft/graphcodebert-base":
        tokenizer = RobertaTokenizer.from_pretrained(args.model_name_or_path)
        config = RobertaConfig.from_pretrained(args.model_name_or_path)
        RobertaModel._keys_to_ignore_on_load_unexpected = ["decoder.*","lm_head.weight","roberta.pooler.dense.*",         'lm_head.layer_norm.weight', 'lm_head.decoder.bias', 'lm_head.bias', 'lm_head.decoder.weight', 'lm_head.dense.weight', 'lm_head.dense.bias', 'lm_head.layer_norm.bias',         'roberta.pooler.dense.weight', 'roberta.pooler.dense.bias']
        model = RobertaModel.from_pretrained(args.model_name_or_path)
    else:
        pass
